...
const Section19 = ({ formData, onFieldChange }) => {
  return (
    <Grid container spacing={2}>
      <Grid item xs={12}>
        <Typography variant="h6">section19</Typography>
      </Grid>
      {formData.heading && (
        <TextField
          fullWidth
          ...
          onChange={(e) =>
            onFieldChange("section19", "heading", e.target.value)
          }
          variant="outlined"
          sx={{ marginBottom: 2 }}
        />
      ...
      {formData.description && (
        <Grid item xs={12}>
          <TextField
            ...
            onChange={(e) =>
              onFieldChange("section19", e.target.name, e.target.value)
            }
            variant="outlined"
          />
        </Grid>
