...
export default function Home() {
    ...
    screendata: {
      steps: [
        ...
        },
        {
          ...
          description: "Monitor and report your progress towards ESG goals...",
        },
      ],
  ...
  // Function to update formData from any section
    ...
    <Box sx={{ display: "flex", height: "100vh", backgroundColor: "#f8f9fc" }}>
      ...
      <Container sx={{ flexGrow: 1, padding: 3 }}>
        ...
        <Paper sx={{ padding: 4, borderRadius: 3, boxShadow: 3 }}>
          ...
          />
          <Section6
            formData={formData.section6}
            onFieldChange={handleFieldChange}
          />
          <Paper sx={{ padding: 4, borderRadius: 3, boxShadow: 3 }}>
            <Section7
              formData={formData.section7}
              onFieldChange={handleFieldChange}
            />
          </Paper>
          <Paper sx={{ padding: 4, borderRadius: 3, boxShadow: 3 }}>
            <Section8
              formData={formData.section8}
              onFieldChange={handleFieldChange}
            />
          </Paper>
          <Paper sx={{ padding: 4, borderRadius: 3, boxShadow: 3 }}>
            <Section9
              formData={formData.section9}
              onFieldChange={handleFieldChange}
            />
          </Paper>
          <Paper sx={{ padding: 4, borderRadius: 3, boxShadow: 3 }}>
            <Section10
              formData={formData.section10}
              onFieldChange={handleFieldChange}
            />
          </Paper>
          <Paper sx={{ padding: 4, borderRadius: 3, boxShadow: 3 }}>
            <Section13
              formData={formData.section13}
              onFieldChange={handleFieldChange}
            />
          </Paper>
          <Paper sx={{ padding: 4, borderRadius: 3, boxShadow: 3 }}>
            <ScreenData
              formData={formData.screendata}
              onFieldChange={handleFieldChange}
            />
          </Paper>

          {/* One Save Changes Button at Parent Level */}
